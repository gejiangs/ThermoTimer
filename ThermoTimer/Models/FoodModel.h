...
@property (nonatomic, assign)   CGFloat customValue;        //自定义温度值(set方法)
@property (nonatomic, assign)   CGFloat gCustomValue;       //自定义温度值(get方法)
@property (nonatomic, assign)   NSInteger selectedIndex;    //选择索引
@property (nonatomic, copy)     NSString *selectedTitle;    //选中的标题
@property (nonatomic, assign)   CGFloat selectedValue;      //选中的温度
